...
const STRAVA_RETROSPECTIVE_MAPS: StravaRetrospectiveRoute[] = [
  ...
  {
    id: 'strava-20152717981',
    stravaId: '20152717981',
    url: 'https://www.strava.com/activities/20152717981',
    mapImageUrl: 'https://d3o5xota0a1fcr.cloudfront.net/v6/maps/A73T23JLUIJCASMUX5374RPTQ3SYITTDWAV3NSBVY2YSBI7NBJ2PG5Q6UXS3CPPYID7NMT23PYVQMYWPHQQY3CS4',
    title: {
      EN: 'MTL ROLL 2026: Saturday Evening Skate',
      FR: 'MTL ROLL 2026 : Rando du Samedi Soir',
      ES: 'MTL ROLL 2026: Patinaje del Sábado Noche',
    },
    subtitle: {
      EN: 'Montreal • Saturday Night Cruise • Jason Muir',
      FR: 'Montréal • Rando Nocturne du Samedi • Jason Muir',
      ES: 'Montreal • Recorrido Nocturno del Sábado • Jason Muir',
    },
    day: {
      EN: 'Saturday Night',
      FR: 'Samedi Soir',
    ...
    color: '#E1FD15',
    highlight: {
      EN: 'Saturday evening GPS activity exploring Montreal corridors during the festival weekend.',
      FR: 'Activité GPS du samedi soir explorant les artères de Montréal durant la fin de semaine du festival.',
      ES: 'Actividad GPS del sábado por la noche recorriendo Montreal durante el fin de semana del festival.',
    },
  },
  {
